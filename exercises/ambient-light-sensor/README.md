...
This folder contains exercises focused on **LDR**, demonstrating how to control an LED using an **LDR (Light Dependent Resistor)**..
...
* **What is an LDR?** An LDR (also known as a photoresistor) is a sensor that varies its electrical resistance according to the intensity of the ambient light. This allows us to measure light levels in a environment.
* **The Resistance Rule:**
